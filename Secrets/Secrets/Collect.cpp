...
int main()
{
	...
	while (!doexit)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			if (((key[0] && player_y >= 0) &&
				!(player_x > 68 && player_x <300 && player_y <202 && player_y>194)&&
				!(player_x > 220 && player_x <500 && player_y < 350 && player_y>345 )))
			...
			if (((key[1] && player_y <= 480 - 32) &&
				!(player_x > 68 && player_x < 300 && player_y < 90 && player_y>67)&&
				!(player_x > 220 && player_x <500 && player_y < 278 && player_y>268)))
			{
				player_y += 4.0;
			}
			...
			if ((key[2] && player_x >= 0)&&
				!(player_x > 290 && player_x <300 && player_y >66 && player_y<198))
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			//wall 1
			al_draw_filled_rectangle(100, 100, 300, 200, al_map_rgb(200, 50, 200));
			//wall 2
			al_draw_filled_rectangle(250, 300, 500, 350, al_map_rgb(255, 100, 100));
			al_flip_display();
		}
	}
