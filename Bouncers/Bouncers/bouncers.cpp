...
int main() {
	...
	float bouncer_x = 30;
	float bouncer_y = 30;
	float bouncer2_x = 300;
	float bouncer2_y = 300;
	float bouncer3_x = 30;
	float bouncer3_y = 300;
	float bouncer4_x = 300;
	float bouncer4_y = 30;
	...
	bouncer2 = al_create_bitmap(32, 64);
	bouncer3 = al_create_bitmap(64, 32);
	bouncer4 = al_create_bitmap(64, 64);
